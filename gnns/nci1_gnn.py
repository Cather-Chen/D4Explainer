...
from torch_geometric.nn import GINEConv, BatchNorm, global_mean_pool, GINConv, GCNConv, LEConv
...
def parse_args():
    ...
    parser.add_argument('--data_path', nargs='?', default=osp.join(osp.dirname(__file__), '..', 'data', 'NCI1'),
